	...
	<div class="login-block effect-1">
		...
		<div class="login-block-content" style="background-color:#020129;  box-shaddow:0 0 24px 1px rgba(1,1,1,.1); ">
			<div class="login-header clearfix">
				<a href="" class=""><img src="{$img}logo-symbol-150.png" alt="RCCG Lighthouse" title="RCCG Lighthouse"/></a>
			...
			<div class="login-body">
				...
				<form method="post" class="sap-form">
					...
					{/if}
					<input type="submit" class="btn btn-default" tabindex="3" value="{lang key='login'}">
					<a href="#" class="btn btn-default" id="js-forgot-dialog">{lang key='forgot_password'}</a>
				</form>
			</div>
