<?php /* Smarty version Smarty-3.1.19, created on 2017-02-03 12:08:58
         compiled from "C:\xaampp\htdocs\lighthouse\admin\templates\default\login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:167475894b3843ea303-60414353%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '972797981500ac609196899a103103321303a843' => 
    array (
      0 => 'C:\\xaampp\\htdocs\\lighthouse\\admin\\templates\\default\\login.tpl',
      1 => 1486141735,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '167475894b3843ea303-60414353',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_5894b3844f4218_25147492',
  'variables' => 
  array (
    'core' => 0,
    'img' => 0,
...
<?php if ($_valid && !is_callable('content_5894b3844f4218_25147492')) {function content_5894b3844f4218_25147492($_smarty_tpl) {?><?php if (!is_callable('smarty_function_ia_hooker')) include 'C:/xaampp/htdocs/lighthouse/includes/smarty/intelli_plugins\\function.ia_hooker.php';
?><!DOCTYPE html>
...
<body id="page-login" style="background-color:#fff">

	<div class="login-block effect-1">

		<div class="login-block-content" style="background-color:#020129;  box-shaddow:0 0 24px 1px rgba(1,1,1,.1); ">
			<div class="login-header clearfix">
				<a href="" class=""><img src="<?php echo $_smarty_tpl->tpl_vars['img']->value;?>
logo-symbol-150.png" alt="RCCG Lighthouse" title="RCCG Lighthouse"/></a>
...
"<?php if ($_smarty_tpl->tpl_vars['code']->value==@constant('IA_LANGUAGE')) {?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['language']->value['title'];?>
					...
					<?php }?>
					<input type="submit" class="btn btn-default" tabindex="3" value="<?php echo iaSmarty::lang(array('key'=>'login'),$_smarty_tpl);?>
">
					<a href="#" class="btn btn-default" id="js-forgot-dialog"><?php echo iaSmarty::lang(array('key'=>'forgot_password'),$_smarty_tpl);?>
</a>
				</form>
			</div>
